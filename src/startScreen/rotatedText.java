...
public class rotatedText extends JPanel {
	...
	int fontSize = 20;
	String[] text = new String[] { "Hi Mom!", "This is a game!", "Welcome!",
			"10/10 -IGN", "Danny Approved", "Kill all Humans", "Fun on a Bun",
			"Watch Out For Bears", "Drugs are Bad", "Better Than Nothing!" };
	int currentText = 7;
